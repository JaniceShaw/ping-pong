  ...
  return (
    <>
      ...
      <p>
        ...
        similique nulla suscipit praesentium facilis eligendi aliquid ...
      </p>
      ...
      <div className="lower-container flex-row justify-center">
        ...
        <div className="btn-group rounded overflow-hidden flex justify-center drop-shadow-2xl">
          <button className="bg-white text-slate-400 hover:bg-amber-400 hover:text-indigo-900 w-full font-semibold pt-1 pb-1">
            Pending
          </button>
          <button className="bg-white text-slate-400 hover:bg-amber-400 hover:text-indigo-900 w-full font-semibold pt-1 pb-1">
            Accepted
