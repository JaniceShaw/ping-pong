...
export const StartPage = () => {
  ...
  return (
    <div className='Start w-full max-w-sm  text-center m-auto'>
        ...
        <Link to="/search">
            <button className='btn block m-auto mb-7 min-w-full'>I need help</button>
        </Link>

        <Link to="/listing/jobs">
            <button className='btn block m-auto mb-7 min-w-full'>I want to help</button>
        </Link>
      ...
      <div className="loginButton mb-6">
          ...
          {logedIn?
              (<Link to="/" className='underline underline-offset-2' onClick={handleLogout}>Logout</Link>)
              :(<span>
                  <p>Have an account?</p>
